...
public class ConfigurationServiceImpl implements IPv4ConfigurationService {
    ...
    /**
     * @see com.qtech.os.net.ipv4.config.IPv4ConfigurationService#addRoute(com.qtech.os.net.ipv4.IPv4Address,
     *      com.qtech.os.net.ipv4.IPv4Address, com.qtech.os.driver.Device, boolean)
     */
    ...
    /**
     * @see com.qtech.os.net.ipv4.config.IPv4ConfigurationService#deleteRoute(com.qtech.os.net.ipv4.IPv4Address,
     *      com.qtech.os.net.ipv4.IPv4Address, com.qtech.os.driver.Device)
     */
