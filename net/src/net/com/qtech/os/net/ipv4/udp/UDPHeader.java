...
import com.qtech.os.net.TransportLayerHeader;
import com.qtech.os.net.ipv4.IPv4Header;
import com.qtech.os.net.ipv4.IPv4Utils;
...
public class UDPHeader implements TransportLayerHeader, UDPConstants {
    ...
    /**
     * @see com.qtech.os.net.LayerHeader#getLength()
     */
    ...
    /**
     * @see com.qtech.os.net.LayerHeader#prefixTo(com.qtech.os.net.SocketBuffer)
     */
