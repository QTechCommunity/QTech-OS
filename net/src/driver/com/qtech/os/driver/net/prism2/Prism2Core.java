...
package com.qtech.os.driver.net.prism2;
...
import com.qtech.os.driver.net.event.LinkStatusEvent;
import com.qtech.os.driver.net.wireless.spi.WirelessDeviceCore;
...
import com.qtech.os.net.wireless.WirelessConstants;
...
import static com.qtech.os.driver.net.prism2.Prism2Constants.Command.ACCESS;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Command.ALLOC;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Command.DISABLE;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Command.ENABLE;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Command.INIT;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Command.TX;
import static com.qtech.os.driver.net.prism2.Prism2Constants.LinkStatus.CONNECTED;
import static com.qtech.os.driver.net.prism2.Prism2Constants.LinkStatus.NOTCONNECTED;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.CNFAUTHENTICATION;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.CNFMAXDATALEN;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.CNFOWNMACADDR;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.CNFPORTTYPE;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.CURRENTBSSID;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.CURRENTSSID;
import static com.qtech.os.driver.net.prism2.Prism2Constants.RecordID.TXRATECNTL;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Register.ALLOCFID;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Register.EVACK;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Register.EVSTAT;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Register.INFOFID;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Register.INTEN;
import static com.qtech.os.driver.net.prism2.Prism2Constants.Register.RXFID;
...
final class Prism2Core extends WirelessDeviceCore implements Prism2Constants,
    ...
    /**
     * @see com.qtech.os.driver.net.spi.AbstractDeviceCore#disable()
     */
    public void disable() {
     ...
     *
     * @throws DriverException
     * @see com.qtech.os.driver.net.wireless.spi.WirelessDeviceCore#getESSID()
     */
    ...
    /**
     * @see com.qtech.os.driver.net.spi.AbstractDeviceCore#getHwAddress()
     */
     ...
     *
     * @see com.qtech.os.driver.net.spi.AbstractDeviceCore#initialize()
     */
    ...
    /**
     * @see com.qtech.os.driver.net.spi.AbstractDeviceCore#release()
     */
    public void release() {
    ...
    /**
     * @see com.qtech.os.driver.net.wireless.spi.WirelessDeviceCore#setESSID(java.lang.String)
     */
    ...
    /**
     * @see com.qtech.os.driver.net.wireless.spi.WirelessDeviceCore#startScan()
     */
    ...
    /**
     * @see com.qtech.os.driver.net.spi.AbstractDeviceCore#transmit(SocketBuffer buf,
...
//                   WLAN_SET_FC_TODS(1) );
    ...
    /**
     * @see com.qtech.os.driver.net.wireless.spi.WirelessDeviceCore#getAuthenticationMode()
     */
    ...
    /**
     * @see com.qtech.os.driver.net.wireless.spi.WirelessDeviceCore#setAuthenticationMode(
