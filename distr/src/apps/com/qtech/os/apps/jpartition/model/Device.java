...
public class Device implements Bounded {
    ...
    private final com.qtech.os.driver.Device device;
    private final boolean hasPartititionTable;

    Device(String name, long size, com.qtech.os.driver.Device device, List<Partition> partitions) {
        this.name = name;
        this.size = size;
     ...
     * @return
     */
    final com.qtech.os.driver.Device getDevice() {
        return device;
    }
