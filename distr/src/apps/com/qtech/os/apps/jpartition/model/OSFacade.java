...
import com.qtech.os.driver.block.PartitionableBlockDeviceAPI;
...
public class OSFacade {
    ...
    final void setOSListener(final OSListener listener) throws OSFacadeException {
        ...
        try {
            DeviceUtils.getDeviceManager().addListener(new DeviceListener() {
                public void deviceStarted(com.qtech.os.driver.Device device) {
                ...
                public void deviceStop(com.qtech.os.driver.Device device) {
                    if (device instanceof IDEDevice) {
                        Device dev = null;
                        try {
                            dev = createDevice(device);
    ...
    final List<Device> getDevices() throws OSFacadeException {
        ...
        try {
            ...
            for (com.qtech.os.driver.Device dev : devMan.getDevicesByAPI(REQUIRED_API)) {
    ...
    private Device createDevice(com.qtech.os.driver.Device dev) throws OSFacadeException {
    ...
    private List<IBMPartitionTableEntry> getPartitions(com.qtech.os.driver.Device dev)
    ...
    @SuppressWarnings("unused")
    private FileSystem<?> getFileSystem(com.qtech.os.driver.Device dev, PartitionTableEntry pte) {
        /*
