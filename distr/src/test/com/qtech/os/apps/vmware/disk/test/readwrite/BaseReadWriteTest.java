...
package com.qtech.os.apps.vmware.disk.test.readwrite;
...
import com.qtech.os.apps.vmware.disk.test.BaseTest;
import com.qtech.os.apps.vmware.disk.test.Utils;
...
public abstract class BaseReadWriteTest extends BaseTest {
    ...
    private static final String DISKS_PACKAGE = "/com/qtech/os/apps/vmware/disk/test/disks/";
