...
package com.qtech.os.test.fs.filesystem;
...
import com.qtech.os.fs.ext2.BlockSize;
import com.qtech.os.fs.ext2.Ext2FileSystemFormatter;
import com.qtech.os.fs.fat.FatType;
import com.qtech.os.test.fs.filesystem.config.FS;
import com.qtech.os.test.fs.filesystem.config.FSAccessMode;
import com.qtech.os.test.fs.filesystem.config.FSTestConfig;
import com.qtech.os.test.fs.filesystem.config.FSType;
import com.qtech.os.test.fs.filesystem.config.FileParam;
import com.qtech.os.test.fs.filesystem.config.OsType;
...
public class FSConfigurations implements Iterable<FSTestConfig> {
    ...
    public FSConfigurations() {
        ...
        configs.addAll(
            fatBuilder.fsType(FSType.FAT).formatter(new com.qtech.os.fs.fat.FatFileSystemFormatter(FatType.FAT12))
                .build());*/
        configs.addAll(
            fatBuilder.fsType(FSType.FAT).formatter(new com.qtech.os.fs.fat.FatFileSystemFormatter(FatType.FAT16))
                .build());
        configs.addAll(
            fatBuilder.fsType(FSType.FAT).formatter(new com.qtech.os.fs.fat.FatFileSystemFormatter(FatType.FAT32))
                .build());
        /* TODO Implement FAT12 writing
