...
import com.qtech.os.fs.FileSystemFullException;
...
public class RAMFile implements FSEntry, FSFile {
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.fs.FSFile#read(long, java.nio.ByteBuffer)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.fs.FSFile#write(long, java.nio.ByteBuffer)
     */
