...
import com.qtech.os.fs.ext2.cache.Block;
import com.qtech.os.fs.ext2.cache.BlockCache;
import com.qtech.os.fs.ext2.cache.INodeCache;
import com.qtech.os.fs.ext4.MultipleMountProtection;
...
public class Ext2FileSystem extends AbstractFileSystem<Ext2Entry> {
    ...
    public static final Charset ENTRY_NAME_CHARSET = Charset.forName(AccessController.doPrivileged(
        new GetPropertyAction("com.qtech.os.fs.ext2.entryNameCharset", "UTF-8")));
    ...
    /**
     * @see com.qtech.os.fs.spi.AbstractFileSystem#createRootEntry()
     */
