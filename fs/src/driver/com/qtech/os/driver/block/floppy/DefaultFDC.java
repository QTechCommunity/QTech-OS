...
import com.qtech.os.driver.system.cmos.CMOSConstants;
import com.qtech.os.driver.system.cmos.CMOSService;
import com.qtech.os.naming.InitialNaming;
import com.qtech.os.system.resource.DMAException;
import com.qtech.os.system.resource.DMAManager;
...
public class DefaultFDC implements FDC {
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#sendCommand(byte[], boolean)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#setupDMA(int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#copyToDMA(byte[], int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#copyFromDMA(byte[], int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#getCommandState(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#setDorReg(int, boolean, boolean)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#getST0()
     */
    ...
    /**
     * @param irq
     * @see com.qtech.os.system.resource.IRQHandler#handleInterrupt(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.qtech.os.driver.block.floppy.FDC#logDMAState()
     */
