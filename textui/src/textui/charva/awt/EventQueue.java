...
*/
    ...
    private final LinkedList<AWTEvent> _lowPriorityQueue = new LinkedList<AWTEvent>();

    private final LinkedList<AWTEvent> _highPriorityQueue = new LinkedList<AWTEvent>();
