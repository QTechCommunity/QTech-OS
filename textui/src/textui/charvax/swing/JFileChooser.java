...
public class JFileChooser
    ...
    protected void fireFileChooserEvent() {
        ...
        while (e.hasMoreElements()) {
            FileChooserListener l = e.nextElement();
    ...
    private class ChooserDialog
        ...
        private final JTextField _locationField = new JTextField(35);
    }
    ...
    private class DirList
        ...
        // INSTANCE VARIABLE
        private final StringBuffer _matchbuf = new StringBuffer();
    }
    ...
    private class NewDirDialog
        ...
        private final JTextField _dirnameField;
    ...
    private interface FileChooserListener extends EventListener {
        void fileChanged(FileChooserEvent e);
    }
