...
public class DefaultTableModel
    ...
    public int getColumnWidth(int column_) {
        int width = _columnWidths.elementAt(column_).intValue();
        return width;
    }
    ...
    public Object getValueAt(int rowIndex_, int columnIndex_) {
        ...
        Vector<Object> rowVector = _dataVector.elementAt(rowIndex_);
    ...
    public void setValueAt(Object value_, int row_, int column_) {
        Vector<Object> rowVector = _dataVector.elementAt(row_);
