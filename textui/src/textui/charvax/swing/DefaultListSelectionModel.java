...
public class DefaultListSelectionModel
    ...
    public int getMinSelectionIndex() {
        try {
            Integer first = _selection.first();
    ...
    protected void fireValueChanged(int firstindex_, int lastindex_) {
        ...
        while (iter.hasNext()) {
            ListSelectionListener l = iter.next();
    ...
    private void handleSelectionChange(TreeSet<Integer> newSelection_) {
        ...
        if (!differences.isEmpty()) {
            Integer first = differences.first();
            Integer last = differences.last();
