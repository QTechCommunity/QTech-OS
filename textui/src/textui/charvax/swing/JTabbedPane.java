...
public class JTabbedPane
    ...
    public void setSelectedIndex(int index_) {
         ...
         */
        if (_selectedIndex != -1) {
            super.remove(_tabComponents.elementAt(_selectedIndex));
         ...
         */
        TabButton tb = _tabs.elementAt(index_);
        tb.setSelected(true);

        /* Add the newly-selected component to the container.
         */
        Component selected = _tabComponents.elementAt(index_);
        super.add(selected);
        super.validate();
    ...
    public void draw(Toolkit toolkit) {
        ...
        if (_selectedIndex != -1) {
            Component component =
                _tabComponents.elementAt(_selectedIndex);
    ...
    public void remove(int index) {
        ...
        Component selected = _tabComponents.elementAt(0);
        _tabComponents.remove(index);
        super.remove(_tabs.elementAt(index));
        _tabs.remove(index);
    ...
    public int indexOfTab(String title) {
        for (int i = 0; i < _tabs.size(); i++) {
            if (title.equals(_tabs.elementAt(i).getText())) {
                return (i);
            }
        }
        return (-1);
    ...
    public String getTitleAt(int index) {
        return _tabs.elementAt(index).getText();
    }
    ...
    public void setTitleAt(int index, String title) {
        _tabs.elementAt(index).setText(title);
    }
    ...
    public void setEnabledAt(int index, boolean enabled) {
        _tabs.elementAt(index).setEnabled(enabled);
    }
    ...
    public boolean isEnabledAt(int index) {
        return _tabs.elementAt(index).isEnabled();
    }
    ...
    public void debug(int level_) {
        ...
        Enumeration<TabButton> e = _tabs.elements();
        while (e.hasMoreElements()) {
            String title = e.nextElement().getText();
    ...
    private final Vector<Component> _tabComponents = new Vector<Component>();
    private final Vector<TabButton> _tabs = new Vector<TabButton>();
