 ...
 * @see QComboBoxButton
 */
public class QComboBoxButton extends JButton {
    ...
    public QComboBoxButton(JComboBox cb, Icon i,
    ...
    public QComboBoxButton(JComboBox cb, Icon i, boolean onlyIcon,
                           CellRendererPane pane, JList list) {
        this(cb, i, pane, list);
        iconOnly = onlyIcon;
    }
    ...
    public void paintComponent(Graphics g) {
        boolean leftToRight = QUIUtils.isLeftToRight(comboBox);
        ...
        if (comboIcon != null) {
            ...
            // Paint the focus
            if (comboBox.hasFocus() && (!QUILookAndFeel.usingOcean() ||
                comboBox.isEditable())) {
                g.setColor(QUILookAndFeel.getFocusColor());
