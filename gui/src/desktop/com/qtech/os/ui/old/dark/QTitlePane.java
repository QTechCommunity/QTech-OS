...
class QTitlePane extends JComponent {
     ...
     */
    private final QRootPaneUI rootPaneUI;
    ...
    private final Color activeBumpsHighlight = QUILookAndFeel.getPrimaryControlHighlight();
    private final Color activeBumpsShadow = QUILookAndFeel.getPrimaryControlDarkShadow();
    private Color activeBackground = null;
    private Color activeForeground = null;
    private Color activeShadow = null;

    // Bumps
    private final QBumps activeBumps
        = new QBumps(0, 0,
        activeBumpsHighlight,
        activeBumpsShadow,
        QUILookAndFeel.getPrimaryControl());
    private final QBumps inactiveBumps
        = new QBumps(0, 0,
    ...
    public QTitlePane(JRootPane root, QRootPaneUI ui) {
        this.rootPane = root;
        rootPaneUI = ui;
    ...
    private void addMenuItems(JMenu menu) {
        ...
        int mnemonic = QUIUtils.getInt("MetalTitlePane.restoreMnemonic", -1);
        ...
        mnemonic = QUIUtils.getInt("MetalTitlePane.iconifyMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
        ...
        if (Toolkit.getDefaultToolkit().isFrameStateSupported(
            ...
            mnemonic =
                QUIUtils.getInt("MetalTitlePane.maximizeMnemonic", -1);
            if (mnemonic != -1) {
                mi.setMnemonic(mnemonic);
            }
        }
        ...
        mnemonic = QUIUtils.getInt("MetalTitlePane.closeMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (isSelected) {
            background = new Color(0x3f3f3f);
            foreground = new Color(0xffffff);
            darkShadow = activeShadow;
            bumps = activeBumps;
        } else {
            background = new Color(0x1f1f1f);
            foreground = new Color(0x3f3f3f);
