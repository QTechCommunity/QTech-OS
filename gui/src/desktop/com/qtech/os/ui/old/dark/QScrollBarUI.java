...
public class QScrollBarUI extends BasicScrollBarUI {
    ...
    protected QBumps bumps;

    protected QScrollButton increaseButton;
    protected QScrollButton decreaseButton;
    ...
    public static ComponentUI createUI(JComponent c) {
        return new QScrollBarUI();
    }

    protected void installDefaults() {
        scrollBarWidth = ((Integer) (UIManager.get("ScrollBar.width"))).intValue();
        super.installDefaults();
        bumps = new QBumps(10, 10, thumbHighlightColor, thumbShadow, thumbColor);
    }
    ...
    protected JButton createDecreaseButton(int orientation) {
        decreaseButton = new QScrollButton(orientation, scrollBarWidth, isFreeStanding);
    ...
    protected JButton createIncreaseButton(int orientation) {
        increaseButton = new QScrollButton(orientation, scrollBarWidth, isFreeStanding);
    ...
    protected void paintTrack(Graphics g, JComponent c, Rectangle trackBounds) {
        ...
        boolean leftToRight = QUIUtils.isLeftToRight(c);
        ...
        if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
            ...
            if (c.isEnabled()) {
                ...
                QUIUtils.drawDisabledBorder(g, 0, 0, trackBounds.width, trackBounds.height);
            }
    ...
    private void oceanPaintThumb(Graphics g, JComponent c,
        ...
        if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
            ...
            QUIUtils.drawGradient(c, g, "ScrollBar.gradient", 2, 2,
                thumbBounds.width - 4,
