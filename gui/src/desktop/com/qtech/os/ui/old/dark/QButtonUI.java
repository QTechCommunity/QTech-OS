...
public class QButtonUI extends BasicButtonUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        QButtonUI qButtonUI =
            (QButtonUI) appContext.get(METAL_BUTTON_UI_KEY);
        if (qButtonUI == null) {
            qButtonUI = new QButtonUI();
            appContext.put(METAL_BUTTON_UI_KEY, qButtonUI);
        }
        return qButtonUI;
    }
    ...
    public void update(Graphics g, JComponent c) {
        ...
        if ((c.getBackground() instanceof UIResource) &&
            ...
            } else if (model.isRollover() && QUIUtils.drawGradient(
                c, g, "Button.gradient", 0, 0, c.getWidth(),
                c.getHeight(), true)) {
                paint(g, c);
                return;
