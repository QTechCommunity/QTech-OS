 ...
 */
class QFontDesktopProperty extends com.sun.java.swing.plaf.windows.DesktopProperty {
    /**
     ...
     *                type.
     */
    QFontDesktopProperty(String key, Toolkit kit, int type) {
        super(key, null, kit);
        this.type = type;
    }
    ...
    protected Object configureValue(Object value) {
        if (value instanceof Integer) {
            value = new Font(DefaultQUITheme.getDefaultFontName(type),
                DefaultQUITheme.getDefaultFontStyle(type),
    ...
    protected Object getDefaultValue() {
        return new Font(DefaultQUITheme.getDefaultFontName(type),
            DefaultQUITheme.getDefaultFontStyle(type),
            DefaultQUITheme.getDefaultFontSize(type));
    }
}
