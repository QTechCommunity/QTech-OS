...
public class QInternalFrameUI extends BasicInternalFrameUI {
    ...
    private static final String IS_PALETTE_KEY = "JInternalFrame.isPalette";
    ...
    public QInternalFrameUI(JInternalFrame b) {
        super(b);
    }
    ...
    protected JComponent createNorthPane(JInternalFrame w) {
        return new QInternalFrameTitlePane(w);
    }
    ...
    private void setFrameType(String frameType) {
        if (frameType.equals(OPTION_DIALOG)) {
            ...
            ((QInternalFrameTitlePane) titlePane).setPalette(false);
        } else if (frameType.equals(PALETTE_FRAME)) {
            LookAndFeel.installBorder(frame, "InternalFrame.paletteBorder");
            ((QInternalFrameTitlePane) titlePane).setPalette(true);
        } else {
    ...
    public void setPalette(boolean isPalette) {
        ...
        ((QInternalFrameTitlePane) titlePane).setPalette(isPalette);
    ...
    private static class MetalPropertyChangeHandler implements
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (!(jif.getUI() instanceof QInternalFrameUI)) {
                return;
            }

            QInternalFrameUI ui = (QInternalFrameUI) jif.getUI();
