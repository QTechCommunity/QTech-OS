...
public class QTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected void installDefaults() {
        ...
        ocean = QUILookAndFeel.usingOcean();
        if (ocean) {
    ...
    protected void paintTopTabBorder(int tabIndex, Graphics g,
        ...
        boolean leftToRight = QUIUtils.isLeftToRight(tabPane);
    ...
    protected boolean shouldFillGap(int currentRun, int tabIndex, int x, int y) {
        ...
        if (currentRun == runCount - 2) {  // If it's the second to last row.
            ...
            if (QUIUtils.isLeftToRight(tabPane)) {
    ...
    protected void paintLeftTabBorder(int tabIndex, Graphics g,
        ...
        if (tabIndex != firstIndex) {
            if (tabPane.getSelectedIndex() == tabIndex - 1) {
                ...
                g.setColor(ocean ? QUILookAndFeel.getWhite() : highlight);
            }
