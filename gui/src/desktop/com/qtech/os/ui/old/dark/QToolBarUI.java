...
public class QToolBarUI extends BasicToolBarUI {
    ...
    static boolean doesMenuBarBorderToolBar(JMenuBar c) {
        JToolBar tb = (JToolBar) QToolBarUI.
        ...
        if (c.isOpaque() && (c.getBackground() instanceof UIResource) &&
            ...
            if (mb != null && mb.isOpaque() &&
                ...
                if (point.x == x && y == point.y + mb.getHeight() &&
                    ...
                    QUIUtils.drawGradient(c, g, "MenuBar.gradient",
            ...
            if (QUIUtils.drawGradient(c, g, "MenuBar.gradient",
    ...
    protected class MetalDockingListener extends DockingListener {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (toolBar.getOrientation() == JToolBar.HORIZONTAL) {
                int x = QUIUtils.isLeftToRight(toolBar) ? 0 : toolBar.getSize().width - 14;
            ...
            if (bumpRect.contains(e.getPoint())) {
                ...
                if (!QUIUtils.isLeftToRight(toolBar)) {
