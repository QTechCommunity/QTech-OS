...
public class QBorders {
    ...
    public static class Flush3DBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y,
                                int w, int h) {
            if (c.isEnabled()) {
                QUIUtils.drawFlush3DBorder(g, x, y, w, h);
            } else {
                QUIUtils.drawDisabledBorder(g, x, y, w, h);
            }
        }
    ...
    public static class ButtonBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (model.isEnabled()) {
                ...
                if (isPressed && isDefault) {
                    QUIUtils.drawDefaultButtonPressedBorder(g, x, y, w, h);
                } else if (isPressed) {
                    QUIUtils.drawPressed3DBorder(g, x, y, w, h);
                } else if (isDefault) {
                    QUIUtils.drawDefaultButtonBorder(g, x, y, w, h, false);
                } else {
                    QUIUtils.drawButtonBorder(g, x, y, w, h, false);
                }
            } else { // disabled state
                QUIUtils.drawDisabledBorder(g, x, y, w - 1, h - 1);
            }
        }
        ...
        private void paintOceanBorder(Component c, Graphics g, int x, int y,
            ...
            g.translate(x, y);
            if (QUIUtils.isToolBarButton(button)) {
                if (model.isEnabled()) {
                    if (model.isPressed()) {
                        g.setColor(QUILookAndFeel.getWhite());
    ...
    public static class InternalFrameBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y,
            ...
            if (c instanceof JInternalFrame && ((JInternalFrame) c).isSelected()) {
                background = QUILookAndFeel.getPrimaryControlDarkShadow();
                highlight = QUILookAndFeel.getPrimaryControlShadow();
                shadow = QUILookAndFeel.getPrimaryControlInfo();
            } else {
                background = QUILookAndFeel.getControlDarkShadow();
                highlight = QUILookAndFeel.getControlShadow();
                shadow = QUILookAndFeel.getControlInfo();
            }
    ...
    static class DialogBorder extends AbstractBorder implements UIResource {
        ...
        protected Color getActiveBackground() {
            return QUILookAndFeel.getPrimaryControlDarkShadow();
        }

        protected Color getActiveHighlight() {
            return QUILookAndFeel.getPrimaryControlShadow();
        }

        protected Color getActiveShadow() {
            return QUILookAndFeel.getPrimaryControlInfo();
        }

        protected Color getInactiveBackground() {
            return QUILookAndFeel.getControlDarkShadow();
        }

        protected Color getInactiveHighlight() {
            return QUILookAndFeel.getControlShadow();
        }

        protected Color getInactiveShadow() {
            return QUILookAndFeel.getControlInfo();
        }
    ...
    public static class OptionDialogBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            switch (messageType) {
                ...
                default:
                    borderColor = QUILookAndFeel.getPrimaryControlDarkShadow();
                    break;
            }
    ...
    public static class MenuBarBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (QUILookAndFeel.usingOcean()) {
                ...
                // toolbar
                if (!QToolBarUI.doesMenuBarBorderToolBar((JMenuBar) c)) {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (c.getParent() instanceof JMenuBar) {
                if (model.isArmed() || model.isSelected()) {
                    ...
                    g.setColor(QUILookAndFeel.getMenuBackground());
    ...
    public static class ToolBarBorder extends AbstractBorder implements UIResource, SwingConstants {
        protected QBumps bumps = new QBumps(10, 10,
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (((JToolBar) c).isFloatable()) {
                if (((JToolBar) c).getOrientation() == HORIZONTAL) {
                    int shift = QUILookAndFeel.usingOcean() ? -1 : 0;
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (!c.isEnabled()) {
                ...
                if (model.isPressed() && model.isArmed()) {
                    ...
                    QUIUtils.drawDark3DBorder(g, x, y, w, h);
                } else {
                    QUIUtils.drawFlush3DBorder(g, x, y, w, h);
                }
            }
    ...
    public static Border getDesktopIconBorder() {
        return new BorderUIResource.CompoundBorderUIResource(
            new LineBorder(QUILookAndFeel.getControlDarkShadow(), 1),
            new MatteBorder(2, 2, 1, 2, QUILookAndFeel.getControl()));
    }
