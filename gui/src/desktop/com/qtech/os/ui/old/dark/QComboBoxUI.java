...
public class QComboBoxUI extends BasicComboBoxUI {
    ...
    protected JButton createArrowButton() {
        ...
        JButton button = new QComboBoxButton(comboBox,
            new QComboBoxIcon(),
            iconOnly,
            currentValuePane,
            listBox);
        ...
        if (QUILookAndFeel.usingOcean()) {
            ...
            button.putClientProperty(QBorders.NO_BUTTON_ROLLOVER,
                Boolean.TRUE);
        }
    ...
    public class MetalPropertyChangeListener extends PropertyChangeHandler {
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (propertyName == "editable") {
                if (arrowButton instanceof QComboBoxButton) {
                    QComboBoxButton button = (QComboBoxButton) arrowButton;
    ...
    public void layoutComboBox(Container parent, MetalComboBoxLayoutManager manager) {
        if (comboBox.isEditable() && !QUILookAndFeel.usingOcean()) {
        ...
        if (arrowButton != null) {
            if (QUILookAndFeel.usingOcean()) {
                ...
                arrowButton.setBounds(QUIUtils.isLeftToRight(comboBox)
        ...
        if (editor != null && QUILookAndFeel.usingOcean()) {
