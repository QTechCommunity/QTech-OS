 ...
 * @see OceanTheme
 */
public class QUILookAndFeel extends BasicLookAndFeel {

    private static boolean METAL_LOOK_AND_FEEL_INITED = false;

    private static QUITheme currentTheme;
    private static final boolean isOnlyOneContext = true;
     ...
     * the package {@code com.qtech.os.ui.old.dark} that are named
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        final String metalPackageName = "com.qtech.os.ui.old.dark.";

        Object[] uiDefaults = {
            "ButtonUI", metalPackageName + "QButtonUI",
            "CheckBoxUI", metalPackageName + "QCheckBoxUI",
            "ComboBoxUI", metalPackageName + "QComboBoxUI",
            "DesktopIconUI", metalPackageName + "QDesktopIconUI",
            "FileChooserUI", metalPackageName + "QFileChooserUI",
            "InternalFrameUI", metalPackageName + "QInternalFrameUI",
            "LabelUI", metalPackageName + "QLabelUI",
            "PopupMenuSeparatorUI", metalPackageName + "QPopupMenuSeparatorUI",
            "ProgressBarUI", metalPackageName + "QProgressBarUI",
            "RadioButtonUI", metalPackageName + "QRadioButtonUI",
            "ScrollBarUI", metalPackageName + "QScrollBarUI",
            "ScrollPaneUI", metalPackageName + "QScrollPaneUI",
            "SeparatorUI", metalPackageName + "QSeparatorUI",
            "SliderUI", metalPackageName + "QSliderUI",
            "SplitPaneUI", metalPackageName + "QSplitPaneUI",
            "TabbedPaneUI", metalPackageName + "QTabbedPaneUI",
            "TextFieldUI", metalPackageName + "QTextFieldUI",
            "ToggleButtonUI", metalPackageName + "QToggleButtonUI",
            "ToolBarUI", metalPackageName + "QToolBarUI",
            "ToolTipUI", metalPackageName + "QToolTipUI",
            "TreeUI", metalPackageName + "QTreeUI",
            "RootPaneUI", metalPackageName + "QRootPaneUI",
        };
    ...
    protected void initSystemColorDefaults(UIDefaults table) {
        QUITheme theme = getCurrentTheme();
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        Object textFieldBorder =
            new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders",
                "getTextFieldBorder");

        Object dialogBorder = new MetalLazyValue(
            "com.qtech.os.ui.old.dark.QBorders$DialogBorder");

        Object questionDialogBorder = new MetalLazyValue(
            "com.qtech.os.ui.old.dark.QBorders$QuestionDialogBorder");
        ...
        Object scrollPaneBorder = new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders$ScrollPaneBorder");
        Object buttonBorder =
            new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders",
                "getButtonBorder");
        ...
        Object desktopIconBorder =
            new SwingLazyValue(
                "com.qtech.os.ui.old.dark.QBorders",
                "getDesktopIconBorder");

        Object menuBarBorder =
            new SwingLazyValue(
                "com.qtech.os.ui.old.dark.QBorders$MenuBarBorder");

        Object popupMenuBorder =
            new SwingLazyValue(
                "com.qtech.os.ui.old.dark.QBorders$PopupMenuBorder");
        Object menuItemBorder =
            new SwingLazyValue(
                "com.qtech.os.ui.old.dark.QBorders$MenuItemBorder");

        Object menuItemAcceleratorDelimiter = "-";
        Object toolBarBorder = new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders$ToolBarBorder");
        ...
        Object[] defaults = {
            ...
            "CheckBox.icon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getCheckBoxIcon"),
            ...
            "RadioButton.icon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getRadioButtonIcon"),
            ...
            // File View 
            "FileView.directoryIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeFolderIcon"),
            "FileView.fileIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeLeafIcon"),
            "FileView.computerIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeComputerIcon"),
            "FileView.hardDriveIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeHardDriveIcon"),
            "FileView.floppyDriveIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeFloppyDriveIcon"),

            // File Chooser
            "FileChooser.detailsViewIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getFileChooserDetailViewIcon"),
            "FileChooser.homeFolderIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getFileChooserHomeFolderIcon"),
            "FileChooser.listViewIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getFileChooserListViewIcon"),
            "FileChooser.newFolderIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getFileChooserNewFolderIcon"),
            "FileChooser.upFolderIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getFileChooserUpFolderIcon"),
            ...
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getHorizontalSliderThumbIcon"),
            "Slider.verticalThumbIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getVerticalSliderThumbIcon"),
            ...
            "InternalFrame.icon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getInternalFrameDefaultMenuIcon"),
            "InternalFrame.border", new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders$InternalFrameBorder"),
            "InternalFrame.optionDialogBorder",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders$OptionDialogBorder"),
            "InternalFrame.paletteBorder", new SwingLazyValue("com.qtech.os.ui.old.dark.QBorders$PaletteBorder"),
            "InternalFrame.paletteTitleHeight", new Integer(11),
            "InternalFrame.paletteCloseIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory$PaletteCloseIcon"),
            "InternalFrame.closeIcon",
            new SwingLazyValue(
                "com.qtech.os.ui.old.dark.QIconFactory",
            ...
            SwingUtilities2.makeIcon(getClass(), QUILookAndFeel.class,
                "icons/sortUp.png"),
            ...
            "com.qtech.os.ui.old.dark.QBorders$TableHeaderBorder"),
            ...
            "Menu.checkIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getMenuItemCheckIcon"),
            "Menu.arrowIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getMenuArrowIcon"),
            ...
            "MenuItem.checkIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getMenuItemCheckIcon"),
            "MenuItem.arrowIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getMenuItemArrowIcon"),
            ...
            // Option Pane Special Dialog Colors, used when QRootPaneUI
            ...
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getCheckBoxMenuItemIcon"),
            "CheckBoxMenuItem.arrowIcon",
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getMenuItemArrowIcon"),
            ...
            new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getRadioButtonMenuItemIcon"),
            ...
            "Tree.openIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeFolderIcon"),
            "Tree.closedIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeFolderIcon"),
            "Tree.leafIcon", new SwingLazyValue("com.qtech.os.ui.old.dark.QIconFactory", "getTreeLeafIcon"),
            "Tree.expandedIcon", new SwingLazyValue(
            "com.qtech.os.ui.old.dark.QIconFactory",
            "getTreeControlIcon",
            new Object[]{Boolean.valueOf(QIconFactory.DARK)}),
            "Tree.collapsedIcon", new SwingLazyValue(
            "com.qtech.os.ui.old.dark.QIconFactory",
            "getTreeControlIcon",
            new Object[]{Boolean.valueOf(QIconFactory.LIGHT)}),
            ...
            "com.qtech.os.ui.old.dark.QBorders$FrameBorder"),
            ...
            "com.qtech.os.ui.old.dark.QBorders$ErrorDialogBorder"),
            ...
            "com.qtech.os.ui.old.dark.QBorders$WarningDialogBorder"),
        ...
        if (isWindows() && useSystemFonts() && theme.isSystemTheme()) {
            ...
            Object messageFont = new QFontDesktopProperty(
                "win.messagebox.font.height", kit, QUITheme.
                CONTROL_TEXT_FONT);
     ...
     * @see QUITheme#addCustomEntriesToTable(UIDefaults)
     */
     ...
     * @see #getCurrentTheme
     */
    public static void setCurrentTheme(QUITheme theme) {
     ...
     * @since 1.5
     */
    public static QUITheme getCurrentTheme() {
        AppContext context = AppContext.getAppContext();

        if (cachedAppContext != context) {
            currentTheme = (QUITheme) context.get("currentMetalTheme");
            if (currentTheme == null) {
                ...
                if (useHighContrastTheme()) {
                    currentTheme = new QUIHighContrastTheme();
                } else {
                    ...
                    if ("steel".equals(theme)) {
                        currentTheme = new DefaultQUITheme();
                    } else {
    ...
    public Icon getDisabledIcon(JComponent component, Icon icon) {
        if ((icon instanceof ImageIcon) && QUILookAndFeel.usingOcean()) {
            return QUIUtils.getOceanDisabledButtonIcon(
    ...
    private static class FontActiveValue implements UIDefaults.ActiveValue {
        ...
        private final QUITheme theme;

        FontActiveValue(QUITheme theme, int type) {
            this.theme = theme;
            this.type = type;
        }
        ...
        public Object createValue(UIDefaults table) {
            Object value = null;
            switch (type) {
                case QUITheme.CONTROL_TEXT_FONT:
                    value = theme.getControlTextFont();
                    break;
                case QUITheme.SYSTEM_TEXT_FONT:
                    value = theme.getSystemTextFont();
                    break;
                case QUITheme.USER_TEXT_FONT:
                    value = theme.getUserTextFont();
                    break;
                case QUITheme.MENU_TEXT_FONT:
                    value = theme.getMenuTextFont();
                    break;
                case QUITheme.WINDOW_TITLE_FONT:
                    value = theme.getWindowTitleFont();
                    break;
                case QUITheme.SUB_TEXT_FONT:
    ...
    static class AATextListener
        ...
        private final String key = SunToolkit.DESKTOPFONTHINTS;
    ...
    private static class MetalLayoutStyle extends DefaultLayoutStyle {
        private static final MetalLayoutStyle INSTANCE = new MetalLayoutStyle();
