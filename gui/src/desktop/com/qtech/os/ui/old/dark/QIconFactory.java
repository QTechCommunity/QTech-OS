 ...
 */
public class QIconFactory implements Serializable {
    ...
    private static class FileChooserDetailViewIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(QUILookAndFeel.getPrimaryControlInfo());
            //     top
            ...
            g.setColor(QUILookAndFeel.getPrimaryControl());
            g.drawRect(3, 3, 2, 3);   // top
            g.drawRect(3, 11, 2, 3);  // bottom

            // Draw inner inner highlight on documents
            g.setColor(QUILookAndFeel.getPrimaryControlHighlight());
    ...
    private static class FileChooserNewFolderIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            // Draw tab on folder
            g.setColor(QUILookAndFeel.getPrimaryControlDarkShadow());
    ...
    public static class PaletteCloseIcon implements Icon, UIResource, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            Color back;
            Color highlight = QUILookAndFeel.getPrimaryControlHighlight();
            Color shadow = QUILookAndFeel.getPrimaryControlInfo();
            if (buttonModel.isPressed() && buttonModel.isArmed()) {
                back = shadow;
            } else {
                back = QUILookAndFeel.getPrimaryControlDarkShadow();
            }
    ...
    private static class InternalFrameCloseIcon implements Icon, UIResource, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            Color backgroundColor = QUILookAndFeel.getPrimaryControl();
            Color internalBackgroundColor =
                QUILookAndFeel.getPrimaryControl();
            Color mainItemColor =
                QUILookAndFeel.getPrimaryControlDarkShadow();
            Color darkHighlightColor = QUILookAndFeel.getBlack();
            Color xLightHighlightColor = QUILookAndFeel.getWhite();
            Color boxLightHighlightColor = QUILookAndFeel.getWhite();

            // if the inactive window
            if (parentButton.getClientProperty("paintActive") != Boolean.TRUE) {
                backgroundColor = QUILookAndFeel.getControl();
                internalBackgroundColor = backgroundColor;
                mainItemColor = QUILookAndFeel.getControlDarkShadow();
                // if inactive and pressed
                if (buttonModel.isPressed() && buttonModel.isArmed()) {
                    internalBackgroundColor =
                        QUILookAndFeel.getControlShadow();
            ...
            // if pressed
                ...
                internalBackgroundColor =
                    QUILookAndFeel.getPrimaryControlShadow();
                xLightHighlightColor = internalBackgroundColor;
                mainItemColor = darkHighlightColor;
    ...
    private static class InternalFrameAltMaximizeIcon implements Icon, UIResource, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            Color ulLightHighlightColor = QUILookAndFeel.getWhite();
            Color lrLightHighlightColor = QUILookAndFeel.getWhite();
    ...
    private static class InternalFrameDefaultMenuIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            Color windowBodyColor = QUILookAndFeel.getWindowBackground();
            Color titleColor = QUILookAndFeel.getPrimaryControl();
            Color edgeColor = QUILookAndFeel.getPrimaryControlDarkShadow();
        ...
        private void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            if (model.isEnabled()) {
                if (model.isPressed() && model.isArmed()) {
                    ...
                    QUIUtils.drawGradient(c, g, "CheckBox.gradient", 0, 0,
                        w, h, true);
                    g.setColor(QUILookAndFeel.getControlDarkShadow());
    ...
    private static class RadioButtonIcon implements Icon, UIResource, Serializable {
        public void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            if (enabled && !pressed) {
                ...
                QUIUtils.drawGradient(c, g, "RadioButton.gradient",
                    1, 1, 10, 10, true);
                ...
                if (pressed) {
                    ...
                    g.setColor(QUILookAndFeel.getControl());
                }
                g.fillRect(2, 2, 8, 8);
                g.fillRect(4, 1, 4, 1);
                g.fillRect(4, 10, 4, 1);
            ...
            if (!enabled) {
                g.setColor(QUILookAndFeel.getInactiveControlTextColor());
            } else {
                g.setColor(QUILookAndFeel.getControlDarkShadow());
            }
            g.drawLine(4, 0, 7, 0);
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            Color shadow = QUILookAndFeel.getControlShadow();
            Color darkCircle = QUILookAndFeel.getControlDarkShadow();
            Color whiteInnerLeftArc = QUILookAndFeel.getControlHighlight();
            Color whiteOuterRightArc = QUILookAndFeel.getControlHighlight();
    ...
    private static class TreeHardDriveIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(QUILookAndFeel.getControlHighlight());
            //     top disk
            g.drawLine(4, 3, 5, 3);
            g.drawLine(7, 3, 9, 3);
    ...
    private static class TreeFloppyDriveIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            // Draw text on label
            g.setColor(QUILookAndFeel.getPrimaryControlShadow());
    ...
    public static class FileIcon16 implements Icon, Serializable {
        ...
        private void paintMe(Component c, Graphics g) {
            ...
            // Draw fill
            g.setColor(QUILookAndFeel.getWindowBackground());
            g.fillRect(4, 2, 9, 12);
    ...
    public static class TreeControlIcon implements Icon, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (image == null || cachedOrientation != QUIUtils.isLeftToRight(c)) {
                cachedOrientation = QUIUtils.isLeftToRight(c);
                if (gc != null) {
                    image = gc.createCompatibleImage(getIconWidth(),
                        getIconHeight(),
                        Transparency.BITMASK);
        ...
        public void paintMe(Component c, Graphics g, int x, int y) {
            ...
            int xoff = (QUIUtils.isLeftToRight(c)) ? 0 : 4;
    ...
    private static class MenuArrowIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (!model.isEnabled()) {
                g.setColor(QUILookAndFeel.getMenuDisabledForeground());
            } else {
                if (model.isArmed() || (c instanceof JMenu && model.isSelected())) {
                    g.setColor(QUILookAndFeel.getMenuSelectedForeground());
                } else {
                    g.setColor(b.getForeground());
                }
            }
            if (QUIUtils.isLeftToRight(b)) {
                g.drawLine(0, 0, 0, 7);
                g.drawLine(1, 1, 1, 6);
                g.drawLine(2, 2, 2, 5);
                g.drawLine(3, 3, 3, 4);
    ...
    private static class CheckBoxMenuItemIcon implements Icon, UIResource, Serializable {
        public void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            g.translate(x, y);
            if (isEnabled) {
                QUIUtils.drawGradient(c, g, "CheckBoxMenuItem.gradient",
                    1, 1, 7, 7, true);
            ...
            if (isSelected) {
                if (isEnabled) {
                    if (isArmed || (c instanceof JMenu && isSelected)) {
                        g.setColor(
                            QUILookAndFeel.getMenuSelectedForeground());
                    } else {
                        g.setColor(QUILookAndFeel.getControlInfo());
                    }
                } else {
    ...
    private static class RadioButtonMenuItemIcon implements Icon, UIResource, Serializable {
        public void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            if (isEnabled) {
                QUIUtils.drawGradient(c, g, "RadioButtonMenuItem.gradient",
                    1, 1, 7, 7, true);
                if (isPressed || isArmed) {
                    g.setColor(QUILookAndFeel.getPrimaryControl());
                } else {
    ...
    private static class VerticalSliderThumbIcon implements Icon, Serializable, UIResource {
        protected static QBumps controlBumps;
        protected static QBumps primaryBumps;

        public VerticalSliderThumbIcon() {
            controlBumps = new QBumps(6, 10,
                QUILookAndFeel.getControlHighlight(),
                QUILookAndFeel.getControlInfo(),
                QUILookAndFeel.getControl());
            primaryBumps = new QBumps(6, 10,
                QUILookAndFeel.getPrimaryControl(),
                QUILookAndFeel.getPrimaryControlDarkShadow(),
                QUILookAndFeel.getPrimaryControlShadow());
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            boolean leftToRight = QUIUtils.isLeftToRight(slider);
            ...
            if (slider.hasFocus()) {
                ...
                g.setColor(slider.isEnabled() ? QUILookAndFeel.getPrimaryControlInfo() :
                    QUILookAndFeel.getControlDarkShadow());
            }
            ...
            // Draw the highlight
            if (slider.isEnabled()) {
                g.setColor(slider.hasFocus() ? QUILookAndFeel.getPrimaryControl()
                    : QUILookAndFeel.getControlHighlight());
                if (leftToRight) {
                    g.drawLine(1, 1, 8, 1);
                    g.drawLine(1, 1, 1, 13);
    ...
    private static class HorizontalSliderThumbIcon implements Icon, Serializable, UIResource {
        ...
        public HorizontalSliderThumbIcon() {
            controlBumps = new QBumps(10, 6,
                QUILookAndFeel.getControlHighlight(),
                QUILookAndFeel.getControlInfo(),
                QUILookAndFeel.getControl());
            primaryBumps = new QBumps(10, 6,
                QUILookAndFeel.getPrimaryControl(),
                QUILookAndFeel.getPrimaryControlDarkShadow(),
                QUILookAndFeel.getPrimaryControlShadow());
        }
    ...
    private static class OceanVerticalSliderThumbIcon extends CachedPainter
        ...
        private static final Polygon LTR_THUMB_SHAPE;
        // Used for clipping when the orientation is right to left
        private static final Polygon RTL_THUMB_SHAPE;
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            paint(c, g, x, y, getIconWidth(), getIconHeight(),
                QUIUtils.isLeftToRight(c), c.hasFocus(), c.isEnabled(),
                QUILookAndFeel.getCurrentTheme());
        }
        ...
        protected void paintToImage(Component c, Image image, Graphics g2,
            ...
            if (!enabled) {
                ...
                QUIUtils.drawGradient(c, g, "Slider.focusGradient",
                    1, 1, 14, 14, false);
            } else {
                QUIUtils.drawGradient(c, g, "Slider.gradient",
                    1, 1, 14, 14, false);
            }
            g.setClip(clip);
            ...
            if (hasFocus) {
                ...
                g.setColor(enabled ? QUILookAndFeel.getPrimaryControlInfo() :
                    QUILookAndFeel.getControlDarkShadow());
            }
...
*/
    ...
    private static class OceanHorizontalSliderThumbIcon extends CachedPainter
        implements Icon, Serializable, UIResource {
        // Used for clipping
        private static final Polygon THUMB_SHAPE;
