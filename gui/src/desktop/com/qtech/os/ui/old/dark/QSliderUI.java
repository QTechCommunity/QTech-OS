 ...
 * @author Tom Santos
 */
public class QSliderUI extends BasicSliderUI {
    ...
    private Rectangle getPaintTrackRect() {
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            if (QUIUtils.isLeftToRight(slider)) {
    ...
    public void paintTrack(Graphics g) {
        ...
        Color trackColor = !slider.isEnabled() ? QUILookAndFeel.getControlShadow() :
    ...
    protected void paintMinorTickForHorizSlider(Graphics g, Rectangle tickBounds, int x) {
        g.setColor(slider.isEnabled() ? slider.getForeground() : QUILookAndFeel.getControlShadow());
