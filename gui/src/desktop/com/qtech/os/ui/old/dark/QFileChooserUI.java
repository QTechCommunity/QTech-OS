 ...
 * @author Jeff Dinkins
 */
public class QFileChooserUI extends BasicFileChooserUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new QFileChooserUI((JFileChooser) c);
    }

    public QFileChooserUI(JFileChooser filechooser) {
        super(filechooser);
    }
    ...
    private class MetalFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
        public JFileChooser getFileChooser() {
            return QFileChooserUI.this.getFileChooser();
        }

        public BasicDirectoryModel getModel() {
            return QFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return QFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return QFileChooserUI.this.createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return QFileChooserUI.this.isDirectorySelected();
        }

        public File getDirectory() {
            return QFileChooserUI.this.getDirectory();
        }

        public Action getChangeToParentDirectoryAction() {
            return QFileChooserUI.this.getChangeToParentDirectoryAction();
        }

        public Action getApproveSelectionAction() {
            return QFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return QFileChooserUI.this.getNewFolderAction();
        }

        public MouseListener createDoubleClickListener(JList list) {
            return QFileChooserUI.this.createDoubleClickListener(getFileChooser(),
                list);
        }

        public ListSelectionListener createListSelectionListener() {
            return QFileChooserUI.this.createListSelectionListener(getFileChooser());
        }
