 ...
 * @author Steve Wilson
 */
public class QScrollButton extends BasicArrowButton {
    ...
    public QScrollButton(int direction, int width, boolean freeStanding) {
        super(direction);
    ...
    public void paint(Graphics g) {
        boolean leftToRight = QUIUtils.isLeftToRight(this);
        boolean isEnabled = getParent().isEnabled();

        Color arrowColor = isEnabled ? QUILookAndFeel.getControlInfo() : QUILookAndFeel.getControlDisabled();
	...
	/*	g.drawLine( 7, 6, 8, 6 );
		...
		g.drawLine( 4, 9, 11, 9 );*/
            ...
            if (isEnabled) {
                ...
                QUIUtils.drawDisabledBorder(g, 0, 0, width, height + 1);
            }
            if (!isFreeStanding) {
                height -= 1;
                g.translate(0, 1);
	...
	/*	g.drawLine( 4, 5, 11, 5 );
		...
		g.drawLine( 7, 8, 8, 8 ); */
            ...
            if (isEnabled) {
                ...
                QUIUtils.drawDisabledBorder(g, 0, -1, width, height + 1);
            }
...
/*		g.drawLine( 5, 4, 5, 11 );
		...
		g.drawLine( 8, 7, 8, 8 );*/
            ...
            if (isEnabled) {
                ...
                QUIUtils.drawDisabledBorder(g, -1, 0, width + 1, height);
            }
            if (!isFreeStanding) {
                height -= 2;
                width -= 1;
	...
	/*	g.drawLine( 6, 7, 6, 8 );
		...
		g.drawLine( 9, 4, 9, 11 );*/
            ...
            if (isEnabled) {
                ...
                QUIUtils.drawDisabledBorder(g, 0, 0, width + 1, height);
            }
