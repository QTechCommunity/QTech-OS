...
public class QInternalFrameTitlePane extends BasicInternalFrameTitlePane {
    ...
    QBumps activeBumps
        = new QBumps(0, 0,
        QUILookAndFeel.getPrimaryControlHighlight(),
    ...
    private final Color activeBumpsHighlight = QUILookAndFeel.
        getPrimaryControlHighlight();
    private final Color activeBumpsShadow = QUILookAndFeel.
    ...
    protected void createButtons() {
        ...
        closeButton.setBackground(QUILookAndFeel.getPrimaryControlShadow());
    ...
    class MetalTitlePaneLayout extends TitlePaneLayout {
        ...
        public void layoutContainer(Container c) {
            boolean leftToRight = QUIUtils.isLeftToRight(frame);
    ...
    public void paintPalette(Graphics g) {
        ...
        if (paletteBumps == null) {
            paletteBumps
                = new QBumps(0, 0,
                QUILookAndFeel.getPrimaryControlHighlight(),
                QUILookAndFeel.getPrimaryControlInfo(),
                QUILookAndFeel.getPrimaryControlShadow());
        }

        Color background = QUILookAndFeel.getPrimaryControlShadow();
        Color darkShadow = QUILookAndFeel.getPrimaryControlDarkShadow();
    ...
    public void paintComponent(Graphics g) {
        ...
        if (isSelected) {
            ...
            if (background == null) {
                background = QUILookAndFeel.getWindowTitleBackground();
            }
            ...
            if (shadow == null) {
                shadow = QUILookAndFeel.getPrimaryControlDarkShadow();
            }
            if (foreground == null) {
                foreground = QUILookAndFeel.getWindowTitleForeground();
            }
            ...
            background = QUILookAndFeel.getWindowTitleInactiveBackground();
            foreground = QUILookAndFeel.getWindowTitleInactiveForeground();
            shadow = QUILookAndFeel.getControlDarkShadow();
            bumps = inactiveBumps;
            gradientKey = "InternalFrame.inactiveTitleGradient";
        }

        if (!QUIUtils.drawGradient(this, g, gradientKey, 0, 0, width,
            height, true)) {
            g.setColor(background);
            g.fillRect(0, 0, width, height);
        }
