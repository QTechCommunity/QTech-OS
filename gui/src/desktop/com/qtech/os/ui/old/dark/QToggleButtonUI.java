 ...
 * @author Tom Santos
 */
public class QToggleButtonUI extends BasicToggleButtonUI {
    ...
    public static ComponentUI createUI(JComponent b) {
        ...
        QToggleButtonUI qToggleButtonUI =
            (QToggleButtonUI) appContext.get(METAL_TOGGLE_BUTTON_UI_KEY);
        if (qToggleButtonUI == null) {
            qToggleButtonUI = new QToggleButtonUI();
            appContext.put(METAL_TOGGLE_BUTTON_UI_KEY, qToggleButtonUI);
        }
        return qToggleButtonUI;
    }
    ...
    public void update(Graphics g, JComponent c) {
        ...
        if ((c.getBackground() instanceof UIResource) &&
            ...
            if (!QUIUtils.isToolBarButton(c)) {
                if (!model.isArmed() && !model.isPressed() &&
                    QUIUtils.drawGradient(
                ...
                QUIUtils.drawGradient(c, g, "ToggleButton.gradient",
