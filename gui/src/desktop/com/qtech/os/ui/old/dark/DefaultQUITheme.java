 ...
 * to {@link QUILookAndFeel#setCurrentTheme} for details on changing
 * the default theme.
 * <p>
 ...
 * @author Steve Wilson
 * @see QUILookAndFeel
 * @see QUILookAndFeel#setCurrentTheme
 */
public class DefaultQUITheme extends QUITheme {
    /**
    ...
    private static final ColorUIResource primary1 = new ColorUIResource(0x4f4f4f);
    private static final ColorUIResource primary2 = new ColorUIResource(0x6f6f6f);
    private static final ColorUIResource primary3 = new ColorUIResource(0x7f7f7f);
    private static final ColorUIResource secondary1 = new ColorUIResource(0x001f3f);
    private static final ColorUIResource secondary2 = new ColorUIResource(0x003f7f);
    private static final ColorUIResource secondary3 = new ColorUIResource(0x007fff);
     ...
     */
    public DefaultQUITheme() {
        install();
    }

    @Override
    protected ColorUIResource getWhite() {
        return new ColorUIResource(new Color(0x5f5f5f));
    }
    ...
    protected ColorUIResource getPrimary1() {
        return new ColorUIResource(new Color(0x4f4f4f));
    }

    @Override
    protected ColorUIResource getPrimary1_5() {
        return new ColorUIResource(new Color(0x5f5f5f));
    }
    ...
    protected ColorUIResource getPrimary2() {
        return new ColorUIResource(new Color(0x6f6f6f));
    }
    ...
    protected ColorUIResource getPrimary3() {
        return new ColorUIResource(new Color(0x7f7f7f));
    }
    ...
    void install() {
        if (QUILookAndFeel.isWindows() &&
            QUILookAndFeel.useSystemFonts()) {
    ...
    boolean isSystemTheme() {
        return (getClass() == DefaultQUITheme.class);
    }
    ...
    private static class WindowsFontDelegate extends FontDelegate {
        private final QFontDesktopProperty[] props;
        private final boolean[] checkedPriviledged;

        public WindowsFontDelegate() {
            props = new QFontDesktopProperty[6];
        ...
        public FontUIResource getFont(int type) {
            ...
            if (props[type] == null) {
                props[type] = new QFontDesktopProperty(type);
            }
