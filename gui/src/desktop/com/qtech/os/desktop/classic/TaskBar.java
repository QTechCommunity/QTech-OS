...
package com.qtech.os.desktop.classic;
...
import com.qtech.os.awt.JNodeGraphicsConfiguration;
...
//        startButton.setBorder(new EmptyBorder(1, 3, 1, 3));
        ...
        awtMenu.add(createMenuItem("AWTDemo", "com.qtech.os.test.gui.AWTDemo"));
        awtMenu.add(createMenuItem("AWTFrameTest", "com.qtech.os.test.gui.AWTFrameTest"));
        awtMenu.add(createMenuItem("AWTMenuBuilderTest", "com.qtech.os.test.gui.AWTMenuBuilderTest"));
        awtMenu.add(createMenuItem("AWTMenuTest", "com.qtech.os.test.gui.AWTMenuTest"));
        awtMenu.add(createMenuItem("AWTTest", "com.qtech.os.test.gui.AWTTest"));
        awtMenu.add(createMenuItem("RobotTest", "com.qtech.os.test.gui.RobotTest"));

        JMenu swingMenu = new JMenu("Swing tests");
        startMenu.add(swingMenu);
        swingMenu.add(createMenuItem("Editor", "com.qtech.os.test.gui.Editor"));
        swingMenu.add(createMenuItem("SwingTest", "com.qtech.os.test.gui.SwingTest"));
        swingMenu.add(createMenuItem("JTableTest", "com.qtech.os.test.gui.JTableTest"));
        swingMenu.add(createMenuItem("JTreeTest", "com.qtech.os.test.gui.JTreeTest"));
        swingMenu.add(createMenuItem("JInternalFrameTest", "com.qtech.os.test.gui.JInternalFrameTest"));
        swingMenu.add(createMenuItem("JDPTest", "com.qtech.os.test.gui.JDPTest"));

        JMenu gamesMenu = new JMenu("Games");
        startMenu.add(gamesMenu);

        gamesMenu.add(createMenuItem("Tetris", "com.qtech.os.games.tetris.Tetris"));
        gamesMenu.add(createMenuItem("BoxWorld", "com.qtech.os.games.boxworld.BoxWorld"));
        gamesMenu.add(createMenuItem("Rubik", "com.qtech.os.games.rubik.Rubik"));

        JMenu toolsMenu = new JMenu("Tools");
        startMenu.add(toolsMenu);

        toolsMenu.add(createMenuItem("Console", "com.qtech.os.apps.console.SwingConsole"));
