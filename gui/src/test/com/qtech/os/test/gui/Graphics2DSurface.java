...
import com.qtech.os.awt.font.FontProvider;
import com.qtech.os.awt.font.TextRenderer;
import com.qtech.os.awt.font.bdf.BDFFont;
import com.qtech.os.awt.font.bdf.BDFFontProvider;
    ...
    public static void main(String[] argv) {
        ...
        f.add(new JComponent() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                tr.render(gs, null, tf, "QTechOS", 100, 100, Color.BLACK);
            }
        });
        f.setSize(400, 400);
