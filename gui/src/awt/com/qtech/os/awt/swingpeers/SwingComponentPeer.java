...
import com.qtech.os.awt.GraphicsFactory;
import com.qtech.os.awt.JNodeGenericPeer;
import com.qtech.os.awt.JNodeGraphics2D;
        ...
        return AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
            public Boolean run() {
                try {
                    ...
                    x.printStackTrace();
                    Unsafe.debug("SwingComponentPeer.requestFocus() exception\n");
...
//        com.qtech.os.vm.Unsafe.debug("JNodeToolkit.updateCursor()-2 " + cur +  " for " + targetComponent + "\n");
//        com.qtech.os.vm.Unsafe.debugStackTrace(100);
