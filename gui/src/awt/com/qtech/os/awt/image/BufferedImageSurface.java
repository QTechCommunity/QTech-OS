...
package com.qtech.os.awt.image;
...
public class BufferedImageSurface extends AbstractSurface {
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#copyArea(int, int, int, int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#drawAlphaRaster(java.awt.image.Raster, java.awt.geom.AffineTransform,
