...
import com.qtech.os.awt.JNodeToolkit;
import com.qtech.os.awt.font.FontManager;
import com.qtech.os.awt.font.TGlyphVector;
import com.qtech.os.driver.video.Surface;
import com.qtech.os.driver.video.util.AbstractSurface;
...
public abstract class SurfaceGraphics2D extends Graphics2D {
    ...
    public void clip(Shape s) {
        //todo implement it
        Unsafe.debug("SurfaceGraphics2D.clip() not implemented\n");
/*
//        todo attempt to fix metal ocean slider painting
        ...
        com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.clip() 1 "+ s + "\n");
        if (clip2D != null) {
            Area as = new Area(s);
        ...
        com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.clip() 2 "+ s + "\n");
        clip2D = s;
    ...
    public void draw(Shape s) {
        ...
        //com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.draw() not implemented\n");
    ...
    public void drawGlyphVector(GlyphVector g, float x, float y) {
        ...
        if (g instanceof TGlyphVector) {
            ...
            Unsafe.debug("Unsupported GlyphVector type: " +
    ...
    public void drawImage(BufferedImage img, BufferedImageOp op, int x, int y) {
        //todo implement it
        Unsafe.debug("SurfaceGraphics2D.drawImage() - 0 not implemented\n");
    }
    ...
    public boolean drawImage(Image img, AffineTransform xform, ImageObserver obs) {
        //todo implement it
        Unsafe.debug("SurfaceGraphics2D.drawImage() - 00 not implemented\n");
        return false;
    }
    ...
    public void drawRenderableImage(RenderableImage img, AffineTransform xform) {
        //todo implement it
        Unsafe.debug("SurfaceGraphics2D.drawRenderableImage() not implemented\n");
    }
    ...
    public void drawRenderedImage(RenderedImage img, AffineTransform xform) {
        //todo implement it
        Unsafe.debug("SurfaceGraphics2D.drawRenderedImage() not implemented\n");
    }
    ...
    public void fill(Shape s) {
        //com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.fill() todo G2D clip & transfom\n");
        //todo G2D clip & transfom
        Point p = simpleGraphics.origin;
        AffineTransform t = AffineTransform.getTranslateInstance(p.x, p.y);
    ...
    public FontRenderContext getFontRenderContext() {
        //todo implement it
        //com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.getFontRendererContext() not implemented\n");
        //return null;
    ...
    public boolean hit(Rectangle rect, Shape s, boolean onStroke) {
        //todo implement it
        Unsafe.debug("SurfaceGraphics2D.hit() not implemented\n");
        return false;
    }
    ...
    public void rotate(double theta) {
        Unsafe.debug("SurfaceGraphics2D.rotate1() invoked\n");
    ...
    public void rotate(double theta, double x, double y) {
        Unsafe.debug("SurfaceGraphics2D.rotate2() invoked\n");
    ...
    public void scale(double sx, double sy) {
        Unsafe.debug("SurfaceGraphics2D.scale() invoked\n");
    ...
    public void setTransform(AffineTransform Tx) {
        //com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.setTransform() invoked\n");
    ...
    public void shear(double shx, double shy) {
        Unsafe.debug("SurfaceGraphics2D.shear() invoked\n");
    ...
    public void transform(AffineTransform Tx) {
        //com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D.transform() invoked\n");
    ...
    public void translate(double tx, double ty) {
        Unsafe.debug("SurfaceGraphics2D.translate() invoked\n");
...
//        if(clip2D == null){
        if (paint == null) {
            ...
            //com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D - 2\n");
...
(Graphics2D.clip() is used with non-rectangular shape + fillRect() with gradient paint)
            ...
            if(paint == null){
                com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D - 3\n");
                //surface.fill(new Rectangle(x, y, width, height), clip2D, af, simpleGraphics.getColor(),
                // Surface.PAINT_MODE);
                x = x + simpleGraphics.origin.x;
                y = y + simpleGraphics.origin.y;

                com.qtech.os.vm.Unsafe.debug("SurfaceGraphics2D - 4\n");
