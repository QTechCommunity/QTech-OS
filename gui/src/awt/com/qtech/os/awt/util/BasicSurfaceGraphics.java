...
public class BasicSurfaceGraphics extends BasicGraphics {
    ...
    public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
        //todo implement it
        Unsafe.debug("SimpleSurfaceGraphics.drawArc() not implemented\n");
    }
    ...
    public void drawOval(int x, int y, int width, int height) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.drawOval() Not implemented\n");
    }
    ...
    public void drawPolygon(int xPoints[], int yPoints[], int nPoints) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.drawPlygon() Not implemented\n");
    }
    ...
    public void drawPolyline(int xPoints[], int yPoints[], int nPoints) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.drawPolyLine() Not implemented\n");
    }
    ...
    public void drawRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.drawRoundRect() Not implemented\n");
    }
    ...
    public void drawString(AttributedCharacterIterator iterator, int x, int y) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.drawString() Not implemented\n");
    }
    ...
    public void fillArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.fillArc() Not implemented\n");
    }
    ...
    public void fillOval(int x, int y, int width, int height) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.fillOval() Not implemented\n");
    }
    ...
    public void fillPolygon(int xPoints[], int yPoints[], int nPoints) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.fillPolygon Not implemented\n");
    }
    ...
    public void fillRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight) {
        //todo
        Unsafe.debug("SimpleSurfaceGraphics.fillRoundRect() Not implemented\n");
    }
