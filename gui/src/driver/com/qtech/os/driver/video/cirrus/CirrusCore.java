...
import com.qtech.os.awt.image.JNodeBufferedImage;
import com.qtech.os.awt.util.BitmapGraphics;
...
import com.qtech.os.driver.video.ddc.DDC1NoSignalException;
import com.qtech.os.driver.video.ddc.DDC1ParseException;
import com.qtech.os.driver.video.ddc.DDC1Reader;
import com.qtech.os.driver.video.ddc.EDID;
import com.qtech.os.driver.video.util.AbstractSurface;
import com.qtech.os.driver.video.util.VesaGTF;
...
public class CirrusCore extends AbstractSurface implements CirrusConstants {
     ...
     * Close the Cirrus FB
     * 
     * @see com.qtech.os.driver.video.Surface#close()
     */
    ...
    /**
     * @see com.qtech.os.driver.video.util.AbstractSurface#convertColor(java.awt.Color)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#copyArea(int, int, int, int, int,
     *      int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#drawCompatibleRaster(java.awt.image.Raster,
    ...
    /**
     * @see com.qtech.os.driver.video.util.AbstractSurface#drawPixel(int, int, int,
     *      int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.util.AbstractSurface#fillRect(int, int, int,
     *      int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#getColorModel()
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#drawAlphaRaster(java.awt.image.Raster,
