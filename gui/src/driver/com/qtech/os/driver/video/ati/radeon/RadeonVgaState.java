...
public class RadeonVgaState extends VgaState implements RadeonConstants {
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaState#toString()
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaState#getPaletteEntry(com.qtech.os.driver.video.vgahw.VgaIO,
     *      int, byte[], byte[], byte[])
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaState#setPaletteEntry(com.qtech.os.driver.video.vgahw.VgaIO,
     *      int, int, int, int)
     */
