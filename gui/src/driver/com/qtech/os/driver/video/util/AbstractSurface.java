...
package com.qtech.os.driver.video.util;
...
public abstract class AbstractSurface implements Surface {
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#draw(Shape, Shape, AffineTransform,
     *      Color, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#getRGBPixel(int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#getRGBPixels(java.awt.Rectangle)
     */
