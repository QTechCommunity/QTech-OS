...
import com.qtech.os.driver.video.vgahw.VgaConstants;
import com.qtech.os.driver.video.vgahw.VgaIO;
import com.qtech.os.driver.video.vgahw.VgaUtils;
...
public final class NVidiaVgaIO implements VgaIO, VgaConstants, NVidiaConstants {
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getATT(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getCRT(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getDACData()
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getGRAF(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getMISC()
     */
    public int getMISC() {
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getSEQ(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getSTAT()
     */
    public int getSTAT() {
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setATT(int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setATTIndex(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setCRT(int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setDACData(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setDACReadIndex(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setDACWriteIndex(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setGRAF(int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setMISC(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#setSEQ(int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.vgahw.VgaIO#getVideoMem()
     */
