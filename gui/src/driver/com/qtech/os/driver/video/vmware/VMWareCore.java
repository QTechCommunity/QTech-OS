...
import com.qtech.os.driver.bus.pci.PCI_IDs;
import com.qtech.os.driver.video.FrameBufferConfiguration;
import com.qtech.os.driver.video.HardwareCursor;
import com.qtech.os.driver.video.HardwareCursorAPI;
import com.qtech.os.driver.video.HardwareCursorImage;
...
public class VMWareCore extends AbstractSurface implements VMWareConstants, PCI_IDs,
    ...
    public VMWareCore(VMWareDriver driver, PCIDevice device) throws ResourceNotFreeException,
        ...
        try {
            ...
            String transparency = SystemProperties.getProperty("com.qtech.os.awt.transparency");
    ...
    /**
     * @see com.qtech.os.driver.video.Surface#fill(Shape, Shape, AffineTransform,
     *      Color, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.HardwareCursorAPI#setCursorPosition(int, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.video.HardwareCursorAPI#setCursorVisible(boolean)
     */
