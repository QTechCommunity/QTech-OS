...
package com.qtech.os.jnasm.assembler;
...
import com.qtech.os.jnasm.assembler.x86.X86Support;

/**
 * @author Levente S\u00e1ntha (lsantha@users.sourceforge.net)
 */
public abstract class Assembler {
    private static final String PARSER_CLASS = "com.qtech.os.jnasm.assembler.gen.JNAsm";
    ...
    public static Assembler newInstance(Reader reader) {
        try {
            Class<?> clazz = Class.forName("com.qtech.os.jnasm.assembler.gen.JNAsm");
