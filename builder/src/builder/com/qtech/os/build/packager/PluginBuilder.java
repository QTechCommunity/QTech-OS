...
import com.qtech.os.build.PluginTask;
import com.qtech.os.build.AbstractPluginTask.LibAlias;
...
public class PluginBuilder extends PackagerTask {
    ...
    public void finish() {
        if (isEnabled()) {
            ...
            try {
                ...
                properties.store(fos, "File automatically generated by QTech OS Packager");
            } catch (IOException e) {
    ...
    private void buildDescriptor(File userJar, File descriptorFile, String pluginId, String alias) {
        ...
        try {
            ...
            out.println("  version=\"\"");
            out.println("  class=\"com.qtech.os.plugin.AutoUnzipPlugin\"");
            ...
            if (userJar.isFile()) {
                ...
                if (!mainClasses.isEmpty()) {
                    out.println("  <extension point=\"com.qtech.os.shell.aliases\">");
            ...
            out.println("  <extension point=\"com.qtech.os.security.permissions\">");
