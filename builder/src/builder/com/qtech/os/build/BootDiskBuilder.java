...
import com.qtech.os.driver.block.MappedFSBlockDeviceSupport;
import com.qtech.os.fs.FileSystemException;
import com.qtech.os.fs.fat.FatType;
import com.qtech.os.fs.fat.GrubBootSector;
import com.qtech.os.fs.fat.GrubFatFormatter;
import com.qtech.os.partitions.ibm.IBMPartitionTableEntry;
import com.qtech.os.partitions.ibm.IBMPartitionTypes;
...
public class BootDiskBuilder extends BootFloppyBuilder {
     ...
     * @throws IOException
     * @see com.qtech.os.build.BootFloppyBuilder#createFormatter()
     */
     ...
     * @see com.qtech.os.build.BootFloppyBuilder#getDeviceLength()
     */
     ...
     * @param rootDevice
     * @return The device
     * @see com.qtech.os.build.BootFloppyBuilder#getSystemDevice(Device)
     */
