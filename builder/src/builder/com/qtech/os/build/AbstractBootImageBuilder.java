...
import com.qtech.os.plugin.model.Factory;
import com.qtech.os.plugin.model.PluginDescriptorModel;
import com.qtech.os.plugin.model.PluginJar;
import com.qtech.os.plugin.model.PluginRegistryModel;
...
public abstract class AbstractBootImageBuilder extends AbstractPluginsTask {
     ...
     */
    public static final String BUILDTIME_PROPERTY = "com.qtech.os.buildtime";
...
//            copyJarFile(blockedObjects, piRegistry);
    ...
    protected Set<String> setupLegalInstanceClasses() {
        ...
        set.add("com.qtech.os.util.Logger");
        return set;
    }
