...
import com.qtech.os.shell.CommandCompletions;
...
import com.qtech.os.shell.bjorne.BjorneInterpreter;
...
import com.qtech.os.shell.syntax.RepeatSyntax;
...
import com.qtech.os.test.shell.Cassowary;
import com.qtech.os.test.shell.syntax.TestShell;
...
public class BjorneCompletionTest {
    ...
    static {
        try {
            ...
            am.add("cpuid", "com.qtech.os.test.shell.MyCpuIDCommand");
            ...
            am.add("echo", "com.qtech.os.test.shell.MyEchoCommand");
