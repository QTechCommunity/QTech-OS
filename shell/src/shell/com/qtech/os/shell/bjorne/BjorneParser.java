...
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_BRACE_GROUP;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_COMMAND;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_ELIF;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_IF;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_LIST;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_SUBSHELL;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_UNTIL;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.CMD_WHILE;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.FLAG_AND_IF;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.FLAG_ASYNC;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.FLAG_BANG;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.FLAG_OR_IF;
import static com.qtech.os.shell.bjorne.BjorneInterpreter.FLAG_PIPE;
import static com.qtech.os.shell.bjorne.BjorneToken.RULE_1_CONTEXT;
import static com.qtech.os.shell.bjorne.BjorneToken.RULE_5_CONTEXT;
import static com.qtech.os.shell.bjorne.BjorneToken.RULE_6_CONTEXT;
import static com.qtech.os.shell.bjorne.BjorneToken.RULE_7a_CONTEXT;
import static com.qtech.os.shell.bjorne.BjorneToken.RULE_7b_CONTEXT;
import static com.qtech.os.shell.bjorne.BjorneToken.RULE_8_CONTEXT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_AMP;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_AMP_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_AND_IF;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_AND_IF_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_ASSIGNMENT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_ASSIGNMENT_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_BANG_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_BAR_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_CASE;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_CASE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_CASE_WORD_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_CLOBBER_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_COMMAND_NAME_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_COMMAND_WORD_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DGREAT_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DLESS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DLESSDASH;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DLESSDASH_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DLESS_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DONE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DO_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_DSEMI_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_ELIF;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_ELIF_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_ELSE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_END_OF_LINE;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_END_OF_LINE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_END_OF_STREAM;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_END_OF_STREAM_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_ESAC_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FILE_NAME_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FI_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FOR;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FOR_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FOR_NAME_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FOR_WORD_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_FUNCTION_NAME_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_GREATAND_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_GREAT_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_HERE_END_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_IF;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_IF_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_IN_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_IO_NUMBER_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LBRACE;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LBRACE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LESSAND_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LESSGREAT_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LESS_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LPAREN;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_LPAREN_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_OR_IF_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_PATTERN_BITS;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_RBRACE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_RPAREN_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_SEMI;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_SEMI_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_THEN_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_UNTIL;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_UNTIL_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_WHILE;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_WHILE_BIT;
import static com.qtech.os.shell.bjorne.BjorneToken.TOK_WORD;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import com.qtech.os.shell.ShellSyntaxException;
