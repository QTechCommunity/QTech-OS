...
package com.qtech.os.shell.help.def;
...
public class DefaultHelpFactory extends HelpFactory {
    ...
    public void help(SyntaxBundle syntaxes, ArgumentBundle bundle, PrintWriter out) {
        ...
        boolean first = true;
        for (com.qtech.os.shell.syntax.Argument<?> arg : bundle) {
    ...
    private Map<String, TreeSet<String>> buildFlagMap(SyntaxBundle syntaxes) {
        ...
        for (com.qtech.os.shell.syntax.Syntax syntax : syntaxes.getSyntaxes()) {
            buildFlagMap(syntax, res);
        }
        return res;
    }

    private void buildFlagMap(com.qtech.os.shell.syntax.Syntax syntax,
        ...
        if (syntax instanceof OptionSyntax) {
            ...
            for (com.qtech.os.shell.syntax.Syntax child : syntax.getChildren()) {
    ...
    public void usage(SyntaxBundle syntaxBundle, ArgumentBundle bundle, PrintWriter out) {
        ...
        com.qtech.os.shell.syntax.Syntax[] syntaxes = syntaxBundle.getSyntaxes();
    ...
    @Override
    public void describeArgument(com.qtech.os.shell.syntax.Argument<?> arg, PrintWriter out) {
