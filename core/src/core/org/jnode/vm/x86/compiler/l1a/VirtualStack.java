...
//  }
    ...
    final class StackManagerImpl implements AbstractX86StackManager {
         ...
         *      com.qtech.os.assembler.x86.X86Register.GPR)
         */
         ...
         *      com.qtech.os.assembler.x86.X86Register.GPR, com.qtech.os.assembler.x86.X86Register.GPR)
         */
        ...
        /**
         * @see AbstractX86StackManager#writePUSH64(int,
         *      com.qtech.os.assembler.x86.X86Register.GPR64)
         */
