...
final class MemoryScannerImpl implements MemoryScanner {
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt16(com.qtech.os.vm.Address, int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt32(com.qtech.os.vm.Address, int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt64(com.qtech.os.vm.Address, int, long, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt8(com.qtech.os.vm.Address, int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt8Array(com.qtech.os.vm.Address, int, byte[], int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt16Array(com.qtech.os.vm.Address, int, char[], int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt16Array(com.qtech.os.vm.Address, int, short[], int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt32Array(com.qtech.os.vm.Address, int, int[], int, int, int)
     */
    ...
    /**
     * @see com.qtech.os.system.resource.MemoryScanner#findInt64Array(com.qtech.os.vm.Address, int, long[], int, int, int)
     */
