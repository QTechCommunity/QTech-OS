...
package com.qtech.os.imageio.jpeg;
...
public class JPEGImageReaderSpi extends ImageReaderSpi {
    ...
    static final String readerClassName = "com.qtech.os.imageio.jpeg.JPEGImageReader";
    static final String[] names = {"JPEG"};
    static final String[] suffixes = {".jpeg", ".jpg", ".jpe"};
    static final String[] MIMETypes = {"image/jpeg"};
    static final String[] writerSpiNames = {"com.qtech.os.imageio.jpeg.JPEGImageWriterSpi"};
    ...
    private static com.qtech.os.imageio.jpeg.JPEGImageReaderSpi readerSpi;
