...
package com.qtech.os.driver.input;
...
public class KeyboardLayoutManager implements ExtensionPointListener {
    ...
    public static final String EP_NAME = "com.qtech.os.driver.input.keyboard-layouts";
    ...
    /**
     * Load the default keyboard layout as specified in the 'com.qtech.os.driver.input.KeyboardLayout'
    ...
    public KeyboardInterpreter createDefaultKeyboardInterpreter() throws KeyboardInterpreterException {
        ...
        String variant = null;
        try {
            ResourceBundle rb = ResourceBundle.getBundle("com.qtech.os.driver.input.KeyboardLayout",
            ...
            log.error("Cannot find the 'com.qtech.os.driver.input.KeyboardLayout' resource bundle", ex);
        }
        if (country != null) {
            try {
    ...
    public KeyboardInterpreter createKeyboardInterpreter(String id) 
        ...
        if (factory != null) {
            ...
            // com.qtech.os.driver.input.l10n plugin.
            final String classI10N = "com.qtech.os.driver.input.l10n.KeyboardInterpreter_" + id;
            try {
