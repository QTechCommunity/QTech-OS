...
import com.qtech.os.driver.console.InputCompleter;
import com.qtech.os.driver.console.TextConsole;
import com.qtech.os.driver.console.spi.AbstractConsole;
...
public class TextScreenConsole extends AbstractConsole implements TextConsole {
     ...
     * Clear the console
     *
     * @see com.qtech.os.driver.console.TextConsole#clear()
     */
    @Override
    public void clear() {
