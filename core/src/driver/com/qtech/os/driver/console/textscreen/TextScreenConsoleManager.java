...
import com.qtech.os.driver.console.spi.AbstractConsoleManager;
...
import com.qtech.os.naming.NameSpaceListener;
...
public class TextScreenConsoleManager extends AbstractConsoleManager {
    ...
    /**
     * @see com.qtech.os.driver.console.ConsoleManager#createConsole(String, int)
     */
