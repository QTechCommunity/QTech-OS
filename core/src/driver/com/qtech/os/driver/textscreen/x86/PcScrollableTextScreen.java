...
package com.qtech.os.driver.textscreen.x86;
...
class PcScrollableTextScreen extends PcBufferTextScreen implements
    ...
    /**
     * @see com.qtech.os.driver.textscreen.ScrollableTextScreen#ensureVisible(int, boolean)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.ScrollableTextScreen#scrollDown(int)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.ScrollableTextScreen#scrollUp(int)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.TextScreen#set(int, char, int, int)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.TextScreen#set(int, char[], int, int, int)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.TextScreen#set(int, char[], int, int, int[], int)
     */
    @Override
