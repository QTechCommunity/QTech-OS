...
import com.qtech.os.driver.textscreen.TextScreen;
...
public class PcTextScreen extends AbstractPcTextScreen {
    ...
    /**
     * @see com.qtech.os.driver.textscreen.TextScreen#copyContent(int, int, int)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.TextScreen#getChar(int)
     */
    @Override
    ...
    /**
     * @see com.qtech.os.driver.textscreen.TextScreen#getColor(int)
     */
    @Override
