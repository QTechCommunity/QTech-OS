...
package com.qtech.os.driver.bus.usb.hub;
...
import com.qtech.os.driver.bus.usb.USBBus;
...
import com.qtech.os.driver.bus.usb.USBHubAPI;
import com.qtech.os.driver.bus.usb.USBHubMonitor;
...
public class USBHubDriver extends Driver implements USBHubAPI, USBHubConstants {
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#clearPortConnectionStatusChanged(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#getDevice(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#getNumPorts()
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#getPortStatus(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#getUSBBus()
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#isPortConnected(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#isPortConnectedToHighSpeed(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#isPortConnectedToLowSpeed(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#isPortConnectionStatusChanged(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#isPortEnabled(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#resetPort(int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#setDevice(com.qtech.os.driver.bus.usb.USBDevice, int)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#setPortEnabled(int, boolean)
     */
    ...
    /**
     * @see com.qtech.os.driver.bus.usb.USBHubAPI#unsetDevice(int)
     */
